...
class Compress
{
  ...
  public function __construct($file_url, $new_name_image, $quality, $pngQuality,
                              $destination = null)
  {
  ...
  {
    //Send image array
    $array_img_types       = array('image/gif', 'image/jpeg', 'image/pjpeg', 'image/png',
      'image/x-png');
    $new_image             = null;
    $last_char             = null;
    ...
    try {
      ...
      $destination_extension = pathinfo($this->new_name_image,
        PATHINFO_EXTENSION);
      //if empty
      ...
      switch ($image_mime) {
        ...
        case 'image/pjpeg':
          ...
          imagejpeg($new_image, $this->destination.$this->new_name_image,
            $this->quality);
          break;
        ...
        case 'image/x-png':
          ...
          imagepng($new_image, $this->destination.$this->new_name_image,
            $png_compression);
          break;
        // if is GIF
        case 'image/gif':
